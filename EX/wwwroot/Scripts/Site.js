    ...
    $.ajax({
        ...
        if (result)
            $("#citiesTable").html(result.map(item => `<tr>
                ...
                <button type="button" class="btn btn-success" onclick="PeoplePopUp('${item.id}')">
...
function PeoplePopUp(id) {
    document.getElementById('peopleCreator').style.display = "block";
    $("#cityId").val(id);
}

//Function To Display Popup
function PeoplePopUpHide() {
    document.getElementById('peopleCreator').style.display = "none";
}
